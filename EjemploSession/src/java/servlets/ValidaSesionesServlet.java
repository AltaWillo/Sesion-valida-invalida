...
public class ValidaSesionesServlet extends HttpServlet {
    ...
    throws ServletException, IOException {
      ...
      if(claveSesion.equals("altairsanchez")){
        try(PrintWriter out=response.getWriter())
        {
            ...
            out.println("<center><h1>Altaír Sánchez</h1></center>");
            out.println("<center><img src='Pug.jpg'></center>");
            out.println("</body>");
            out.println("</html>");
        }
      }
      else
      {
          try(PrintWriter out=response.getWriter())
        {
            ...
            out.println("<center><h1>Altaír Sánchez</h1></center>");
            out.println("<center><img src='tahe.png'></center>");
            out.println("</body>");
            out.println("</html>");
        }
      }
